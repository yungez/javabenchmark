...
const vmImageConfig = JSON.parse(fs.readFileSync('./azure/vmImageConfig.json', 'utf8'));
...
function createOrGetVirtualMachine(resourceGroupName, vmName, location, size, osType, callback) {
