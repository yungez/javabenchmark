...
// aws
// 1. elasticBeanStalk
resource.createOrGetAWSElasticBeanStalk = function (region, appName, envName, size, versionlabel, callback) {
    return awsElasticBeanStalk.createElasticBeanstalkWebApp(region, appName, envName, size, versionlabel, callback);
}
